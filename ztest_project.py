...
df = pd.read_csv("medium_data_1.csv")
...
fig = ff.create_distplot([mean_list], ["date"], show_hist=False)
...
fig.add_trace(go.Scatter(x=[third_std_deviation_end, third_std_deviation_end], y=[0, 0.17], mode="lines", name="STANDARD DEVIATION 3 END"))
fig.show()
zscores1=(mean-mean_of_sample1)/std_deviation
print(zscores1)
zscores2=(mean-mean_of_sample2)/std_deviation
print(zscores2)
zscores3=(mean-mean_of_sample3)/std_deviation
print(zscores3)